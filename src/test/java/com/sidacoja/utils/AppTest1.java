...
public class AppTest1 {
	...
	public void testApp02() {
		...
		sdcj.columns(new String[] {
				...
				// "Block",
				// "IUCR",
				"Primary Type", "Description", "Location Description", "Arrest", "Updated On" });

		sdcj.sequence(new String[] { "Case Number", "Arrest" });
	...
	public void testApp01() {
		...
		sdcj.columns(new String[] { "First Name", "Last Name", "UserID", "Date" });

		sdcj.sequence(new String[] { "First Name", "Last Name", "UserID", "Date" });
	...
	public void testApp03() {
		...
		sdcj.columns(new String[] { "CURRENCY1", "AMOUNT", "ACCOUNT" });
		sdcj.sequence(new String[] { "AMOUNT", "ACCOUNT" });
